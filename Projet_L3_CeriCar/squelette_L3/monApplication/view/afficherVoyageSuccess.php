<div id="content">
    <div id="voyageChoisi" class ="shadow p-3 mb-5 bg-white rounded" style="background-color:#fafbfc;border-width:3px" data-id="<?php 
        ...
        <?php foreach($context->conducteurs as $conducteur) {?>
            ...
            <p style ="color: rgb(5, 71, 82);font-size: 18px;font-weight: 600;font-family: 'Trebuchet MS', serif;" ><?php echo "conducteur  :". $conducteur->nom . " ".$conducteur->prenom?></p>
            <p style="color: rgb(112, 140, 145);font-size: 18px;line-height: 20px;font-family: 'Trebuchet MS', serif;"><?php echo"Contrainte : " .$context->contraintes ?> </p>    
        </div>
        <?php } ?>
        </div>
        </hr>
        ...
        <div class="row">
           ...
           <?php if(isset($_SESSION['user_id'])){ ?> <button id="submitReservation" class="btn btn-info reservation" style="font-size: 18px;font-weight: 500;font-family: 'Trebuchet MS', serif;">Reserver</button> <?php } ?>
    ...
    $("#submitReservation").click(function(){
        ...
        $.ajax({
            ...
            success : function(code_html, statut){ 
                ...
                let b = document.getElementById("banner").innerHTML = "reservation success";
            }
            });
