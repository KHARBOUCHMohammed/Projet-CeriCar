...
$(document).ready(function(){
    $('#newVoyage').submit(function(){
            ...
            if(true){
                  $.ajax({
                   url : 'newDispatcher.php?action=newVoyagePost',
                   data: $(this).serialize(),
                   type : 'POST',
                   ...
                   success : function(html, statut){ // code_html contient le HTML renvoyé
                       ...
                       //console.log(html);
                           ...
                           $("#page_maincontent").html("<div class='alert alert-success' role='alert'>Le voyage a été créé <a href='?action=mesVoyages'>Consulter vos voyages </a></div>");
